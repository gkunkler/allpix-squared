...
# x_values, x_name, x_units = coulomb_distance_limits, "Coulomb Distance Limit", "cm"
# x_values, x_name, x_units = num_charges_values, "Number of Electrons", ""
# x_values, x_name, x_units = spot_sizes, "Initial RMS", "um"
x_values, x_name, x_units = time_step_values, "Time Step", "ns"


y_values, y_name, y_units = e_rms_final_values, "Final RMS Values", "mm"
# y_values, y_name, y_units = interactive_time_values, "Time Spent on InteractivePropagation", "ms"

# Separated by color in each subplot
# line_values, line_name, line_units = time_step_values, "Time Step", "ns" 
# line_values, line_name, line_units = spot_sizes, "Initial RMS", "um"
# line_values, line_name, line_units = enable_coulomb_values, "CR", ""
line_values, line_name, line_units = coulomb_distance_limits, "Distance Limit", "cm"

# separates into horizontal (1) and vertical (2) subplots (can be filtered)
# filter_1_values, filter_1_name, filter_1_units, filter_1 = num_charges_values, "Number of Electrons", "", [1000] 
# filter_1_values, filter_1_name, filter_1_units, filter_1 = coulomb_distance_limits, "Distance Limit", "cm", [2e-4, 1e-1]
filter_1_values, filter_1_name, filter_1_units, filter_1 = enable_coulomb_values, "CR", "", [0,1]

# filter_2_values, filter_2_name, filter_2_units, filter_2 = coulomb_field_limits, "Coulomb Field Limit", "V/cm", [4e5]
# filter_2_values, filter_2_name, filter_2_units, filter_2 = coulomb_distance_limits, "Coulomb Distance Limit", "cm", [2e-4, 1e-1]
filter_2_values, filter_2_name, filter_2_units, filter_2 = num_charges_values, "# Electrons", "", [1000] 
# filter_2_values, filter_2_name, filter_2_units, filter_2 = enable_coulomb_values, "CR", "", [0,1]

extra_title = "Field Limit: 4e5 V/cm"
...
for ax, i, j, filter_1_value, filter_2_value in zip(axes.flatten(), both_indices[0], both_indices[1], both_filters[0], both_filters[1]):
    ...
    ax.set_title(f'{filter_1_title}, {filter_2_title}, {extra_title}')
    # ax.set_xscale('log')
    ax.grid(True)
    ax.legend()
