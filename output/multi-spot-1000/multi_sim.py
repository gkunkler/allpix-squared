...
coulomb_distance_limits = [1e-4, 1.5e-4, 2e-4, 1e-1] #cm
repeats = 2
time_steps = [0.01,0.1] #ns
spot_sizes = [0.1, 0.3, 0.5, 0.7, 1] #um
coulomb_field_limits = [1e5,4e5,7e5]
