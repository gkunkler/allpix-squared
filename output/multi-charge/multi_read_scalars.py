...
for ax, i, j, filter_1_value, filter_2_value in zip(axes.flatten(), both_indices[0], both_indices[1], both_filters[0], both_filters[1]):
    ...
    ax.plot([100,  300,  500,  700, 1000, 1300, 1500], [0.0147685,  0.0147925,  0.01512287, 0.01519522, 0.01512616, 0.01507729,0.01521086], color='black', linestyle=':', linewidth=2, label="No Coulomb Repulsion")
    # [0.0147685,  0.0147925,  0.01512287, 0.01519522, 0.01512616, 0.01507729,0.01521086]
    # [114.9825, 142.5125, 203.777, 193.6545, 262.81, 248.1805, 257.9285]
