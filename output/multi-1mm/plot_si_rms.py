...
configs = ['d1_cr1_eh_0','d1_cr1_eh_-100','d1_cr1_eh_-200','d1_cr1_eh_-300','d1_cr1_eh_-400']
# names = ['Electrons only','Electrons & Holes','Electrons, Holes, Mirror Charges']
names = ['0V','-100V', '-200V', '-300V', '-400V']
linestyles = ['-', '--', ':', '-.', '--']
title_addition = "Electrons and Holes, no Mirror Charges"
...
rms_fig.suptitle(f'Charge Spread During Propagation ({title_addition})')
